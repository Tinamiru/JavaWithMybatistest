...
//		}
		...
		/*
		 * 응답결과가 여라개 일 경우에는 selectList()메서드를 이용한다. 이 메서드는 여러개의 레코드를 VO에 담은 후 이 VO데이터를
		...
		// 응답 결과가 1개인것이 확실할 경우에는 selectOne ()메서드를 이용한다.
